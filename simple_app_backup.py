"""
Simple Streamlit App for Renovation Cost Estimator
...
st.subheader("Simple Version for Testing")

st.markdown("""
This is a simplified version of the Renovation Cost Estimator app to test deployment.
...
# Footer
st.markdown("---")
st.caption("© 2024 Renovation Estimator - Simple Test Version")
